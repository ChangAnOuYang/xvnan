 ...
 */
public class PolyElement<E extends Element> extends AbstractPolyElement<E, com.xvnan.jpbc.plaf.field.poly.PolyField> {

    public PolyElement(com.xvnan.jpbc.plaf.field.poly.PolyField<Field> field) {
        super(field);
    }


    public com.xvnan.jpbc.plaf.field.poly.PolyField getField() {
        return field;
    }
