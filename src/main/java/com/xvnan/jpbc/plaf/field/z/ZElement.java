 ...
 */
public class ZElement extends AbstractZElement<com.xvnan.jpbc.plaf.field.z.ZField> {


    public ZElement(com.xvnan.jpbc.plaf.field.z.ZField  field) {
        super(field);

        this.value = BigInteger.ZERO;
    }

    public ZElement(com.xvnan.jpbc.plaf.field.z.ZField field, BigInteger value) {
        super(field);
