...
import com.xvnan.jpbc.plaf.field.base.AbstractVectorElement;
import com.xvnan.jpbc.plaf.field.vector.ImmutableVectorElement;
import com.xvnan.jpbc.plaf.field.vector.VectorElementPowPreProcessing;
 ...
 */
public class VectorElement<E extends Element> extends AbstractVectorElement<E, com.xvnan.jpbc.plaf.field.vector.VectorField> {


    public VectorElement(com.xvnan.jpbc.plaf.field.vector.VectorField field) {
        super(field);
    ...
    public VectorElement(com.xvnan.jpbc.plaf.field.vector.VectorField field, List<E> coeff) {
        super(field);
        this.field = field;
