...
import com.xvnan.jpbc.plaf.field.z.AbstractZElement;
import com.xvnan.jpbc.plaf.field.z.SymmetricZrField;
import com.xvnan.jpbc.plaf.util.Arrays;
 ...
 */
public class SymmetricZrElement<F extends SymmetricZrField> extends com.xvnan.jpbc.plaf.field.z.AbstractZElement<F> {
    ...
    public SymmetricZrElement set(Element value) {
        this.value = ((com.xvnan.jpbc.plaf.field.z.AbstractZElement) value).value.mod(order);
...
//        value = value.modPow(BigIntegerUtils.TWO, order);
    ...
    public SymmetricZrElement add(Element element) {
        value = value.add(((com.xvnan.jpbc.plaf.field.z.AbstractZElement) element).value).mod(order);
