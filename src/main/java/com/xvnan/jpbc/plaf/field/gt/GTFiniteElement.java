...
import com.xvnan.jpbc.plaf.field.gt.ImmutableGTFiniteElement;
...
public class GTFiniteElement extends AbstractElement {
    ...
    public GTFiniteElement(PairingMap pairing, com.xvnan.jpbc.plaf.field.gt.GTFiniteField field) {
        super(field);
    ...
    public GTFiniteElement(PairingMap pairing, com.xvnan.jpbc.plaf.field.gt.GTFiniteField field, Element value) {
        super(field);
    ...
    public GTFiniteElement duplicate() {
        return new GTFiniteElement(pairing, (com.xvnan.jpbc.plaf.field.gt.GTFiniteField) field, value.duplicate());
    }
    ...
    public com.xvnan.jpbc.plaf.field.gt.GTFiniteField getField() {
