...
import com.xvnan.jpbc.plaf.field.poly.AbstractPolyElement;
import com.xvnan.jpbc.plaf.field.poly.ImmutablePolyModElement;
import com.xvnan.jpbc.plaf.field.poly.PolyElement;
import com.xvnan.jpbc.plaf.field.poly.PolyField;
import com.xvnan.jpbc.plaf.field.poly.PolyModField;
import com.xvnan.jpbc.plaf.field.poly.PolyUtils;
import com.xvnan.jpbc.plaf.util.math.BigIntegerUtils;
 ...
 */
public class PolyModElement<E extends Element> extends AbstractPolyElement<E, com.xvnan.jpbc.plaf.field.poly.PolyModField> {


    public PolyModElement(com.xvnan.jpbc.plaf.field.poly.PolyModField field) {
        super(field);
...
*/
    ...
    public PolyModElement<E> sqrt() {
        com.xvnan.jpbc.plaf.field.poly.PolyField polyField = new com.xvnan.jpbc.plaf.field.poly.PolyField(field.getRandom(), field);

        com.xvnan.jpbc.plaf.field.poly.PolyElement f = polyField.newElement();
        com.xvnan.jpbc.plaf.field.poly.PolyElement r = polyField.newElement();
        com.xvnan.jpbc.plaf.field.poly.PolyElement s = polyField.newElement();
    ...
    public PolyModElement<E> setFromPolyTruncate(com.xvnan.jpbc.plaf.field.poly.PolyElement<E> element) {
    ...
    protected com.xvnan.jpbc.plaf.field.poly.PolyElement polyInvert(com.xvnan.jpbc.plaf.field.poly.PolyElement f) {
        PolyField<Field> polyField = f.getField();

        com.xvnan.jpbc.plaf.field.poly.PolyElement q = polyField.newElement();

        com.xvnan.jpbc.plaf.field.poly.PolyElement b0 = polyField.newZeroElement();
        com.xvnan.jpbc.plaf.field.poly.PolyElement b1 = polyField.newOneElement();
        com.xvnan.jpbc.plaf.field.poly.PolyElement b2 = polyField.newElement();

        com.xvnan.jpbc.plaf.field.poly.PolyElement r0 = field.irreduciblePoly.duplicate();
        com.xvnan.jpbc.plaf.field.poly.PolyElement r1 = f.duplicate();
        PolyElement r2 = polyField.newElement();

        Element inv = f.getField().getTargetField().newElement();

        while (true) {
            com.xvnan.jpbc.plaf.field.poly.PolyUtils.div(q, r2, r0, r1);
            if (r2.isZero())
                break;
