...
public class PolyModField<F extends Field> extends AbstractFieldOver<F, PolyModElement> {
    protected com.xvnan.jpbc.plaf.field.poly.PolyElement irreduciblePoly;
    ...
    public PolyModField(SecureRandom random, F targetField, int cyclotomicPolyDegree) {
        ...
        com.xvnan.jpbc.plaf.field.poly.PolyField polyField = new PolyField(random, targetField);
    ...
    public PolyModField(SecureRandom random, com.xvnan.jpbc.plaf.field.poly.PolyElement irreduciblePoly) {
