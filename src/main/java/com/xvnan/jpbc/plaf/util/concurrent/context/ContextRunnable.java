package com.xvnan.jpbc.plaf.util.concurrent.context;

import com.xvnan.jpbc.plaf.pairing.parameters.MutablePairingParameters;
import com.xvnan.jpbc.plaf.util.concurrent.context.ContextExecutor;
...
public abstract class ContextRunnable implements Runnable, MutablePairingParameters {
    ...
    private String name;
    private com.xvnan.jpbc.plaf.util.concurrent.context.ContextExecutor executor;
    ...
    public com.xvnan.jpbc.plaf.util.concurrent.context.ContextExecutor getExecutor() {
        return executor;
    }
