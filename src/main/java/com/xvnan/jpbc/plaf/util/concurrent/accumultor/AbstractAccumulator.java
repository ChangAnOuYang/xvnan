...
import com.xvnan.jpbc.plaf.util.concurrent.PoolExecutor;
 ...
 * @since 2.0.0
 */
public abstract class AbstractAccumulator<T> extends PoolExecutor<T> implements com.xvnan.jpbc.plaf.util.concurrent.accumultor.Accumulator<T> {
    ...
    public com.xvnan.jpbc.plaf.util.concurrent.accumultor.Accumulator<T> accumulate(Callable<T> callable) {
        submit(callable);
