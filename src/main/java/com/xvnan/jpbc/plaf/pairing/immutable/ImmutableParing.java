...
import com.xvnan.jpbc.plaf.pairing.immutable.ImmutablePairingPreProcessing;
...
public class ImmutableParing implements Pairing {
    ...
    public Field getFieldAt(int index) {
        ...
        if (field == null) {
            fieldMap.put(index, (field = new com.xvnan.jpbc.plaf.pairing.immutable.ImmutableField(pairing.getFieldAt(index))));
        }
        return field;
    }

    public int getFieldIndex(Field field) {
        if (field instanceof com.xvnan.jpbc.plaf.pairing.immutable.ImmutableField)
