package com.xvnan.jpbc.plaf.pairing;

import com.xvnan.jpbc.api.Pairing;
import com.xvnan.jpbc.api.PairingParameters;
import com.xvnan.jpbc.plaf.pairing.a.TypeAPairing;
import com.xvnan.jpbc.plaf.pairing.a1.TypeA1Pairing;
import com.xvnan.jpbc.plaf.pairing.d.TypeDPairing;
import com.xvnan.jpbc.plaf.pairing.e.TypeEPairing;
import com.xvnan.jpbc.plaf.pairing.f.TypeFPairing;
import com.xvnan.jpbc.plaf.pairing.g.TypeGPairing;
import com.xvnan.jpbc.plaf.pairing.immutable.ImmutableParing;
import com.xvnan.jpbc.plaf.pairing.parameters.PropertiesParameters;
...
public class PairingFactory {
    ...
    public static class CTL13MultilinearPairingCreator implements PairingCreator {
        ...
        public CTL13MultilinearPairingCreator() {
            try {
                Class pbcPairingFactoryClass = Class.forName("com.xvnan.jpbc.plaf.mm.clt13.pairing.CTL13PairingFactory");
    ...
    public class EllipticCurvesPairingCreator implements PairingCreator {
        ...
        public EllipticCurvesPairingCreator() {
            ...
            try {
                Class pbcPairingFactoryClass = Class.forName("com.xvnan.jpbc.plaf.pbc.PBCPairingFactory");
